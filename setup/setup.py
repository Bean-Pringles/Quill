...
BUILD_SCRIPT_DIR = os.path.join(SCRIPT_DIR, "scripts")
# ----------------------------------------
...
def compileProject():
    ...
    if osName == "Windows":
        ...
        expectedExe = os.path.join(compilerDir, "compiler.exe")
    else:  # Linux/macOS
        ...
        expectedExe = os.path.join(compilerDir, "compiler")
...
def updatePathWindows():
    ...
    try:
        ...
        print(f"[*] Manual setup: Add {SCRIPT_DIR} to your user PATH environment variable")
